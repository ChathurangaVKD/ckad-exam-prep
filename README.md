...
```bash
# Install a local Kubernetes cluster (macOS)
...
# Launch the interactive study guide CLI
node index.js
...
| [yaml-templates.md](./quick-reference/yaml-templates.md) | Copy-paste YAML templates for every resource |
...
| | Day 14 | Quick reference review + rest |
...
- 🖥 [Killer.sh CKAD Simulator](https://killer.sh/ckad) — Most realistic simulator
